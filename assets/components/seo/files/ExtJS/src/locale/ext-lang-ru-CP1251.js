...
if(Ext.form.Field){
  Ext.form.Field.prototype.invalidText = "Значение в втом поле неверное";
}
...
if(Ext.PagingToolbar){
  Ext.apply(Ext.PagingToolbar.prototype, {
    ...
    displayMsg     : "Отображаются записи ? {0} по {1}, всего {2}",
...
if(Ext.form.VTypes){
  Ext.apply(Ext.form.VTypes, {
    emailText     : 'Это поле должно содержать адрес ?лектронной почты в формате "user@example.com"',
    urlText       : 'Это поле должно содержать URL в формате "http:/'+'/www.example.com"',
    alphaText     : 'Это поле должно содержать только латин?кие буквы и символ подчеркивания "_"',
    alphanumText  : 'Это поле должно содержать только латин?кие буквы, цифры и символ подчеркивания "_"'
  });
}
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      ...
      italic : {
        title: 'Кур?ив (Ctrl+I)',
        text: 'Применение кур?ивного начертания к выделенному тексту.',
        cls: 'x-html-editor-tip'
      },
      underline : {
      ...
      justifyleft : {
        title: 'Выровн?ть текст по левому краю',
      ...
      justifyright : {
        title: 'Выровн?ть текст по правому краю',
        text: 'Выровнивание текста по правому краю.',
        cls: 'x-html-editor-tip'
      },
      insertunorderedlist : {
        title: 'Маркеры',
        text: '?ачать маркированный список.',
        cls: 'x-html-editor-tip'
      },
      insertorderedlist : {
        title: 'Нумерация',
...
if(Ext.grid.GridView){
  Ext.apply(Ext.grid.GridView.prototype, {
    ...
    unlockText   : "Сн?ть закрепление столбца",
    columnsText  : "Столбцы"
  });
}
...
if(Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion){
  Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
    splitTip            : "Тяните для изменения размера.",
    collapsibleSplitTip : "Тяните для изменения размера. Двойной щелчок спрсчет панель."
  });
}
