			...
			items:[

				{
					...
					items:[{
						...
						icon: this.sourcePath + 'source/images/icons/arrow_refresh.png',
...

					{
						...
						icon: this.sourcePath + 'source/images/icons/find.png', 
					...
					columns:[
						...
						},
						{
                            ...
                            renderer: function(value, c, r){
                                ...
                                if(user_id = r.get('user_id')){
                                    var user = r.get('fullname') || value;
                                    var a = MODx.action['security/user/update'];
                                    var url = MODx.config.manager_url + "?a=" + a + "&id=" + user_id;
						...
						},
						{
							...
							renderer: function(status){ 
								switch(status){
									case 200:
										return '<span style="color:green;">Доступен</span>';
										break;
									case 403:
										return '<span style="color:red;">Доступ запрещен</span>';  
										break;
									case 404:
										return '<span style="color:red;">Страница не найдена</span>';  
										break;
									case 503:
										return '<span style="color:red;">Сайт не доступен</span>';  
										break;
