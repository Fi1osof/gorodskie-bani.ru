	...
	<div id="content">
        ...
        <div id="sidebar">
            ...
            *}
            ...
            <div class="">  
                [[!Wayfinder?startId=`1192`&level=`1`&outerClass=`menu`]] 
            </div>
            
            <div class="title">Разделы</div>  	
            <div class="">  
                [[!Wayfinder?startId=`1247`&level=`1`&outerClass=`menu`]] 
            </div>
            ...
            <div class="img-block">
                <noindex>
                    <a href="http://www.radimax.ru/" title="Чугунные радиаторы в стиле РЕТРО" target="_blank"><img src="assets/images/ad/radimax_220.jpg" /></a>
                </noindex>
            </div> 
