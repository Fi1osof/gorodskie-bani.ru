...
<html>
    ...
    <!-- meta -->
        ...
        <title>{block name=title_wrapper}{block name=title}{if $modx->getOption('site_start') != $modx->resource->id}{block meta_title}{$meta_title}{/block} | {/if}{$site_name}{/block} | Обзоры, отзывы{/block}</title>
        ...
        <div class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            ...
            *}
            ...
            {snippet name="Wayfinder@BootstrapTopMenu"}
            ...
            <div id="main" class="container">
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        ...
                        {block pagetitle}
                            <h1 class="page-header"><span class="title">{block pagetitle_text}{$modx->resource->longtitle|default:$modx->resource->pagetitle}{/block}</span></h1>
                        {/block}
                        
                        {block name=Breadcrumbs}
                            {if !in_array($modx->resource->id, [
                                989
                            ])}
