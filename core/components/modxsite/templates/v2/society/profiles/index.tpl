    ...
    {if $user}
        ...
        <div class="profile">
            ...
            <div class="row">
                <div class="col-md-3">
                    {if $photo || $avatar}
                        <img class="avatar img-responsive" src="{$baseUrl}{$photo|default:$avatar}"/>
                    {/if}
                    ...
                    {if $comments_count}
                        Написал <a href="profile/{$username}/stream/">{$comments_count} {$comments_count|spell:"комментарий":"комментария":"комментариев"}</a>
                    {else}
            ...
            {if $regedon = $user->SocietyProfile->createdon}
            ...
            <div class="row">
                <div class="col-md-5 col-sm-5">
                    ...
                    {else}
                        ...
                        <p>Если у вас есть вопросы или предложения, можете воспользоваться формой обратной связи на <a href="{$modx->makeUrl(239)}">странице контактов</a>.</p>
                    {/if}
