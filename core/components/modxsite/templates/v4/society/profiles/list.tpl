...
<h1 class="page-header">{$modx->resource->longtitle|default:$modx->resource->pagetitle}</h1>
            ...
            {foreach $result.object as $object}
                ...
                <tr>
                    ...
                    <td class="w10">
                        ...
                        <a href="profile/{$object.username}" title="{$object.fullname|default:$object.username}"><img src="{$thumb}"/></a>
                    </td>
