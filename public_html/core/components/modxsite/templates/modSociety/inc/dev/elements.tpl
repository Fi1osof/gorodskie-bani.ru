...
<div class="container">
  <div class="demo-row demo-buttons">
    ...
    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-primary">Primary Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-warning">Warning Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-default">Default Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-danger">Danger Button</a>
    </div>

    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-success">Success Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-inverse">Inverse Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-info">Info Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block disabled">Disabled Button</a>
    </div>
  </div> <!-- /row -->
  ...
  <div class="demo-row demo-buttons">
    ...
    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-block btn-primary">Huge Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-block btn-primary">Default Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-block btn-primary">Mini Button</a>
    </div>

    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-block btn-primary">Large Button</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-block btn-primary">Small Button</a>
    </div>
  </div> <!-- /row -->
  ...
  <div class="demo-row demo-buttons">
    ...
    <div class="demo-content">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary">
        <i class="fui-twitter"></i>
        It's a
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary mhm">
        Huge
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary">
        Button
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary mlm">
        <i class="fui-check-inverted"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary btn-embossed mlm">
        Embossed
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-hg btn-primary btn-block">
        Huge Fluid Button
        <i class="fui-arrow-right pull-right"></i>
      </a>

      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary">
        <i class="fui-twitter"></i>
        It's a
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary mhm">Large</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary">
        Button
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary mlm">
        <i class="fui-check-inverted"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary btn-embossed mlm">
        Embossed
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-lg btn-primary btn-block">
        Large Fluid Button
        <i class="fui-arrow-right pull-right"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary">
        <i class="fui-twitter"></i>
        It's a
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary mhm">
        Standard
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary">
        Button
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary mlm">
        <i class="fui-check-inverted"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary btn-embossed mlm">
        Embossed
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary btn-block">
        Standard Fluid Button
        <i class="fui-arrow-right pull-right"></i>
      </a>

      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary">
        <i class="fui-twitter"></i>
        It's a
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary mhm">Small</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary">
        Button
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary mlm">
        <i class="fui-check-inverted"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary btn-embossed mlm">
        Embossed
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-primary btn-block">
        Small Fluid Button
        <i class="fui-arrow-right pull-right"></i>
      </a>

      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary">
        <i class="fui-twitter"></i>
        It's a
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary mhm">Mini</a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary">
        Button
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary mlm">
        <i class="fui-check-inverted"></i>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary btn-embossed mlm">
        Embossed
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-xs btn-primary btn-block">
        Mini Fluid Button
        <i class="fui-arrow-right pull-right"></i>
      </a>
    </div>
    ...
    <div class="demo-content">
      <div class="clearfix">
        ...
        <div class="pull-left mll pvl">
          <div class="btn-toolbar">
            <div class="btn-group">
              <a class="btn btn-primary" href="{$modx->resource->uri}#fakelink"><i class="fui-list-columned"></i></a>
              <a class="btn btn-primary" href="{$modx->resource->uri}#fakelink"><i class="fui-list-numbered"></i></a>
              <a class="btn btn-primary active" href="{$modx->resource->uri}#fakelink"><i class="fui-list-thumbnailed"></i></a>
              <a class="btn btn-primary" href="{$modx->resource->uri}#fakelink"><i class="fui-list-small-thumbnails"></i></a>
            </div>
          </div> <!-- /toolbar -->
        </div>
      </div>
      ...
      <div class="mbl">
          ...
          <ul>
            ...
            <li class="pagination-dropdown dropup">
              ...
              <ul class="dropdown-menu">
                <li><a href="{$modx->resource->uri}#fakelink">10&ndash;20</a></li>
                <li><a href="{$modx->resource->uri}#fakelink">20&ndash;30</a></li>
                <li><a href="{$modx->resource->uri}#fakelink">40&ndash;50</a></li>
              </ul>
            </li>
        ...
        <div class="pagination pagination-minimal">
          <ul>
            ...
            <li><a href="{$modx->resource->uri}#fakelink">9</a></li>
            <li><a href="{$modx->resource->uri}#fakelink">10</a></li>
            <li><a href="{$modx->resource->uri}#fakelink">11</a></li>
            <li><a href="{$modx->resource->uri}#fakelink">12</a></li>
            <li class="next"><a href="{$modx->resource->uri}#fakelink" class="fui-arrow-right"></a></li>
          </ul>
        </div><!-- /pagination -->
      </div>
      ...
      <div class="mbl">
        <ul class="pagination-plain">
          <li class="previous"><a href="{$modx->resource->uri}#fakelink">&larr; Previous</a></li>
          ...
          <li><a href="{$modx->resource->uri}#fakelink">9</a></li>
          <li><a href="{$modx->resource->uri}#fakelink">10</a></li>
          <li class="next"><a href="{$modx->resource->uri}#fakelink">Newer &rarr;</a></li>
        </ul>
      </div>
  ...
  <div class="demo-row demo-tabs">
    ...
    <div class="demo-content">
      <ul class="nav nav-tabs">
        <li class="active"><a href="{$modx->resource->uri}#">Popular</a></li>
        <li><a href="{$modx->resource->uri}#">Newest</a></li>
        <li><a href="{$modx->resource->uri}#">Bestselling</a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="{$modx->resource->uri}#tab2">Newest</a></li>
            <li><a href="{$modx->resource->uri}#tab3">Bestselling</a></li>
          </ul>
        </li>
      </ul> <!-- /tabs -->

      <ul class="nav nav-tabs nav-append-content">
        <li class="active"><a href="{$modx->resource->uri}#tab1">Popular</a></li>
        <li><a href="{$modx->resource->uri}#tab2">Newest</a></li>
        <li><a href="{$modx->resource->uri}#tab3">Bestselling</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="{$modx->resource->uri}#">
  ...
  <div class="demo-row">
    ...
    <div class="demo-content">
      ...
      <div class="iconbar iconbar-success">
        <ul>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-user"></a></li>
          <li class="active"><a href="{$modx->resource->uri}#fakelink" class="fui-calendar"></a></li>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-chat"></a></li>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-mail"></a></li>
          <li>
            <a href="{$modx->resource->uri}#fakelink" class="fui-gear">
      ...
      <div class="iconbar iconbar-danger">
        <ul>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-user"></a></li>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-calendar"></a></li>
          <li class="active"><a href="{$modx->resource->uri}#fakelink" class="fui-chat"></a></li>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-mail"></a></li>
          <li>
            <a href="{$modx->resource->uri}#fakelink" class="fui-gear">
              <span class="iconbar-unread">1</span>
      ...
      <div class="iconbar iconbar-warning">
        <ul>
          ...
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-calendar"></a></li>
          <li><a href="{$modx->resource->uri}#fakelink" class="fui-chat"></a></li>
          <li class="active"><a href="{$modx->resource->uri}#fakelink" class="fui-mail"></a></li>
          <li>
            <a href="{$modx->resource->uri}#fakelink" class="fui-gear">
              <span class="iconbar-unread">1</span>
            </a>
  ...
  <div class="demo-row">
    ...
    <div class="demo-content">
      ...
      <div class="breadcrumb-text">
        ...
        <p>
          <a href="{$modx->resource->uri}#fakelink" class="text-primary">House</a>
          <a href="{$modx->resource->uri}#fakelink" class="text-info">Bedroom</a>
          <a href="{$modx->resource->uri}#fakelink" class="text-warning">Bed</a>
          <a href="{$modx->resource->uri}#fakelink" class="text-danger">Decor</a>
          A-Z
        </p>
      </div>
    </div>
  ...
  <div class="demo-row demo-social-buttons">
    ...
    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-googleplus">
        <i class="fui-googleplus"></i>
        Connect with Google
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-facebook">
        <i class="fui-facebook"></i>
        Connect with Facebook
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-twitter">
        <i class="fui-twitter"></i>
    ...
    <div class="demo-col">
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-pinterest">
        <i class="fui-pinterest"></i>
        Pin It
        <span class="btn-tip">100</span>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-linkedin">
        <i class="fui-linkedin"></i>
        Share
        <span class="btn-tip">91</span>
      </a>
      <a href="{$modx->resource->uri}#fakelink" class="btn btn-sm btn-social-stumbleupon">
  ...
  <div class="demo-row">
    ...
    <div class="demo-content">
      ...
      <div class="alert alert-info">
        ...
        Your computer restarted <a href="{$modx->resource->uri}#fakelink">because of a problem</a>. Sorry for any inconvenience and appreciate your patient.
      </div>

      <div class="alert alert-info">
        <button type="button" class="close fui-cross" data-dismiss="alert"></button>
        <h3>Information Lable</h3>
        <p>An error message is information displayed when an <a href="{$modx->resource->uri}#fakelink">unexpected condition occurs</a>, usually on a computer or other device. On modern operating systems with graphical user interfaces, error messages are often displayed using dialog boxes.</p>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-info btn-wide">Turn it off now</a>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-wide">It’s ok</a>
      </div>
      ...
      <div class="alert alert-error">
        ...
        <p>An error message is information displayed when an <a href="{$modx->resource->uri}#fakelink">unexpected condition occurs</a>, usually on a computer or other device. On modern operating systems with graphical user interfaces, error messages are often displayed using dialog boxes.</p>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-danger btn-wide">Turn it off now</a>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-wide">It’s ok</a>
      </div>
      ...
      <div class="alert alert-success">
        ...
        <p>An error message is information displayed when an <a href="{$modx->resource->uri}#fakelink">unexpected condition occurs</a>, usually on a computer or other device. On modern operating systems with graphical user interfaces, error messages are often displayed using dialog boxes.</p>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-primary btn-wide"><i class="fui-check-inverted"></i> Hurray!</a>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-info btn-wide">Share on twitter</a>
      </div>
      ...
      <div class="alert">
        ...
        <p>An error message is information displayed when an <a href="{$modx->resource->uri}#fakelink">unexpected condition occurs</a>, usually on a computer or other device. On modern operating systems with graphical user interfaces, error messages are often displayed using dialog boxes.</p>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-warning btn-wide">Fix it</a>
        <a href="{$modx->resource->uri}#fakelink" class="btn btn-wide">Okey, no probs!</a>
      </div>
    </div> <!-- /demo-content -->
  </div> <!-- /row -->
</div> <!-- /.container -->
...
<div class="container">
  ...
  <div class="demo-row pbn">
  	<div class="demo-title pbm">
  		<h3 class="demo-panel-title">Top Menus</h3>
  	</div>
    <div class="demo-content-wide ptl">
      <div class="navbar">
          ...
          <div class="container">
            ...
            <div class="nav-collapse collapse in" id="nav-collapse-01">
              <ul class="nav">
                ...
                <li><a href="{$modx->resource->uri}#fakelink">Features</a></li>
                <li><a href="{$modx->resource->uri}#fakelink">Pricing</a></li>
                <li><a href="{$modx->resource->uri}#fakelink">About</a></li>
              </ul> <!-- /nav -->
      ...
      <div class="navbar">
        <div class="navbar-inner">
          <div class="container">
            ...
            <a href="{$modx->resource->uri}#fakelink" class="navbar-brand fui-flat"></a>
            <div class="nav-collapse collapse in" id="nav-collapse-02">
              <form class="navbar-search pull-right" action="">
                <div class="input-group input-group-sm">
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <div class="container">
            ...
            <a href="{$modx->resource->uri}#fakelink" class="navbar-brand">Flat UI</a>
            <div class="nav-collapse collapse in" id="nav-collapse-03">
              ...
              <ul class="nav pull-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="{$modx->resource->uri}#fakelink">Action</a></li>
                    <li><a href="{$modx->resource->uri}#fakelink">Another action</a></li>
                    <li><a href="{$modx->resource->uri}#fakelink">Something else here</a></li>
                    <li class="divider"></li>
                    <li><a href="{$modx->resource->uri}#fakelink">Separated link</a></li>
                  </ul>
                </li>
              </ul> <!-- /nav -->
            </div><!--/.nav-collapse -->
...
<div class="container ptl">
  <div class="demo-row typography-row">
  	...
  	<div class="demo-content">      		
          ...
          <img src="{$template_url}libs/ui/images/exaple-image.jpg" alt="exaple-image" class="img-rounded img-responsive">
  ...
  <div class="demo-row">
    ...
    <div class="demo-content-wide ptl">
      <div id="myCarousel" class="carousel slide" data-interval="false">
        ...
        <!-- Controls -->
        <a class="left carousel-control fui-arrow-left" href="{$modx->resource->uri}#myCarousel" data-slide="prev"></a>
        <a class="right carousel-control fui-arrow-right" href="{$modx->resource->uri}#myCarousel" data-slide="next"></a>
      </div>
    </div><!-- /.demo-content -->
  </div><!-- /.demo-row -->
  ...
  <div class="demo-row demo-illustrations">
    ...
    <div class="demo-content-wide">
      <div><img src="{$template_url}libs/ui/images/icons/android.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/android1.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/app-store.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/arrow.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/art.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/bag.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/basket.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/book.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/bowling.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/box.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/brush.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/building.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/bulb.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/button.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/calculator.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/calendar.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/camera.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/car.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/card.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/chair.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/chat.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/clipboard.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/clocks.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/compas.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/converse.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/cup.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/dj.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/donut.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/dude.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/dynamite.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/earth.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/egg.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/eye.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/file.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/fit.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/flag.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/flask.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/flower.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/games.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/gift-box.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/girl.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/goal.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/google .svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/graph.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/icecream.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/imac.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/ipad.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/iphone.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/key.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/lettersymbol.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/lock.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/loop.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/macbook.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/magic.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/magicmouse.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/mail.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/map.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/medal.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/mic.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/money.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/mortarboard.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/mountain.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/news.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/paper-bag.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/pc.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/pencil.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/pencils.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/picture.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/pig.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/pills.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/play.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/printer.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/responsive.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/retina.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/ring.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/rocket.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/rss.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/safe.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/save.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/search.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/settings.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/shield.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/shirt.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/skateboard.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/spray.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/storage.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/support.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/ticket.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/toilet-paper.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/touch.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/trash.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/trip-bag.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/trunk.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/ubmrella.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/user-interface.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/video.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/weather.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/wi-fi.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/wine.svg" alt="" /></div>
				<div><img src="{$template_url}libs/ui/images/icons/yinyang.svg" alt="" /></div>
    </div><!-- /.demo-content -->
  </div><!-- /.demo-row -->
...
{ldelim}include file="layout/text/error.tpl" message="Не были указаны данные для активации"{rdelim}
