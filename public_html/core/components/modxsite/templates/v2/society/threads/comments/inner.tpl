<div id="comment-{$comment.id}" class="comment inner-tpl">
    ...
    <div class="comment-body">
        ...
        <div class="comment-info">
          ...
          <!--Рейтинг: <strong class="green">526</strong>
          <br>Сообщений: 46223-->
        </div>
    ...
    {if $canReply}
        <div class="comment-reply" data-comment-obj="society-comment-cont" data-comment-id="{$comment.id}">
        	<a data-comment-obj="society-comment-action-reply" class="reviews-button-small comment-button" href="javascript:void(0)">Ответить</a>
