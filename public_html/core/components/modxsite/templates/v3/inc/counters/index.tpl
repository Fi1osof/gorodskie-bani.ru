...
<div id="developer" style="position: absolute;right: 0;top: 16px;">
...
<div id="metrika" style="position: absolute; right: 0px; top: 55px;">
...
{literal}
    ...
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter26848689 = new Ya.Metrika({id:26848689,
                        webvisor:true,
                        clickmap:true,
                        trackLinks:true,
